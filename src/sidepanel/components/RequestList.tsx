        ...
        return (
          ...
          <span className="request-url" title={req.url}>
            {req.vulnerabilities && req.vulnerabilities.length > 0 && (
              <span style={{ display: 'inline-flex', alignItems: 'center', marginRight: 6, color: 'var(--accent-red)' }} title={`${req.vulnerabilities.length} security warnings detected`}>
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ filter: 'drop-shadow(0 0 3px rgba(255, 51, 102, 0.45))' }}>
            ...
            {req.notes && req.notes.trim() !== '' && (
              <span style={{ display: 'inline-flex', alignItems: 'center', marginRight: 6, color: 'var(--accent-yellow)' }} title="Contains researcher notes">
                <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ filter: 'drop-shadow(0 0 3px rgba(255, 170, 0, 0.45))' }}>
